        ...
        <div className="bg-card border border-[var(--aro-border)] rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="w-full h-11 rounded-xl border border-border bg-secondary text-foreground font-semibold flex items-center gap-3 px-4 hover:bg-secondary/80 transition-colors disabled:opacity-50"
            >
