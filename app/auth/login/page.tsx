        ...
        <div className="bg-card border border-[var(--aro-border)] rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="h-11 bg-[var(--aro-green)] hover:bg-[var(--aro-green-dark)] text-[var(--aro-bg)] font-semibold rounded-xl mt-1 transition-all duration-200"
            >
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link href="/auth/signup" className="text-[var(--aro-green)] hover:text-[var(--aro-green-light)] font-medium transition-colors">
              Create one
            </Link>
          </p>
        </div>
