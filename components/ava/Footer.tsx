    ...
    <footer className="relative overflow-hidden">
        ...
        <div className="relative z-10 bg-[var(--ava-surface)] border border-[var(--ava-border)] rounded-3xl p-12 md:p-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-5 text-balance">
              Start closing deals{' '}
              <span className="text-gradient-pink">tonight</span>
            </h2>
            <p className="text-[var(--ava-text-muted)] text-lg mb-8 max-w-xl mx-auto text-pretty">
              Join hundreds of business owners who let AVA handle their WhatsApp sales. Set up in under 10 minutes. No credit card required.
            </p>
      ...
      <div className="border-t border-[var(--ava-border)] px-6 py-12 max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2">
            ...
            <p className="text-[var(--ava-text-muted)] text-sm leading-relaxed max-w-xs">
              AI-powered sales automation for WhatsApp. Close more deals, reply instantly, and grow your business while you sleep.
            </p>
        ...
        <div className="mt-12 pt-6 border-t border-[var(--ava-border)] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[var(--ava-text-muted)] text-xs">
            © {new Date().getFullYear()} AVA. All rights reserved.
          </p>
          <p className="text-[var(--ava-text-muted)] text-xs">
            Built with AI. Powered by OpenRouter.
          </p>
        </div>
      </div>
