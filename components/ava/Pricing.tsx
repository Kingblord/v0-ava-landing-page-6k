    ...
    <section id="pricing" className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-[#8892a4] text-lg max-w-xl mx-auto mb-8">
            No hidden fees. Cancel anytime. Every plan includes a 14-day free trial — no
        ...
        >
          <p className="text-[#8892a4] text-sm">
            Have questions?{' '}
            <a href="#faq" className="text-[#8b7cf0] hover:text-[#00D1B2] transition-colors underline underline-offset-2">
              Check our FAQ
            </a>{' '}
            or{' '}
            <a href="mailto:hello@ava.ai" className="text-[#8b7cf0] hover:text-[#00D1B2] transition-colors underline underline-offset-2">
              talk to sales
            </a>
            .
          </p>
