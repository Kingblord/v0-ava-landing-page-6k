...
const headlineWords = ['Your', 'AI', 'Sales', 'Agent', 'That', 'Closes', 'Deals', 'While', 'You', 'Sleep']
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <span className="block">Your AI Sales</span>
              <span className="block">Agent That</span>
              <span className="block text-gradient">Closes Deals</span>
            ...
            >
              AVA handles every customer conversation on{' '}
              <span className="text-[#f0f4ff] font-medium">WhatsApp & Telegram</span> —
              answering questions, negotiating prices, and collecting payments automatically.
              Your business sells 24/7, even while you&apos;re offline.
            </motion.p>

            {/* Social proof */}
            <motion.div variants={itemVariants} className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {['#6C5CE7', '#00D1B2', '#e040fb', '#8b7cf0', '#33dbc2'].map(
                  (color, i) => (
                    <div
                      key={i}
              ...
              <div>
                ...
                <p className="text-xs text-[#8892a4] mt-0.5">
                  <span className="text-[#f0f4ff] font-semibold">2,400+</span> businesses
                  scaling with AVA
                </p>
              </div>
            </motion.div>
            ...
            >
              {[
                { label: '$4.2M+ Revenue Generated', color: '#00D1B2' },
                { label: 'No Credit Card Required', color: '#6C5CE7' },
                { label: 'Setup in 5 Minutes', color: '#8b7cf0' },
              ].map((item) => (
        ...
        >
          <span className="text-[11px] text-[#8892a4] tracking-widest uppercase">
            Scroll
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
